...
<div class="flex-col">
  ...
  <div v-click class="card-green" style="border-radius:10px;">
    ...
    <div style="background:#f0fff4;border-radius:8px;padding:10px 12px;font-family:'Fira Code',monospace;font-variant-ligatures:none;font-size:.7rem;line-height:1.9;">
