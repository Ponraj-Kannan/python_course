...
<div class="flex-col">
  ...
  <div v-click style="background:#f6f8fa;border-radius:10px;border:1px solid #e1e4e8;padding:14px;font-family:'Fira Code',monospace;font-variant-ligatures:none;font-size:.78rem;line-height:2;">
  ...
  <div v-after style="display:flex;flex-direction:column;gap:8px;">
    <div style="display:flex;align-items:center;gap:10px;">
      <div style="background:var(--red-soft);border:2px dashed var(--red);border-radius:10px;padding:10px 18px;min-width:80px;text-align:center;">
        ...
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--red-dark);font-size:.85rem;">name</div>
      </div>
      ...
      <div style="background:#f0fff4;border:2px solid var(--green);border-radius:10px;padding:10px 18px;flex:1;text-align:center;">
        ...
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--green);font-size:.85rem;">"Alice"</div>
      </div>
    </div>
    <div style="display:flex;align-items:center;gap:10px;">
      <div style="background:var(--red-soft);border:2px dashed var(--red);border-radius:10px;padding:10px 18px;min-width:80px;text-align:center;">
        <div style="font-size:.62rem;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">Label</div>
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--red-dark);font-size:.85rem;">age</div>
      </div>
      <div style="color:var(--muted);font-size:1.2rem;font-weight:900;">→</div>
      <div style="background:#f0fff4;border:2px solid var(--green);border-radius:10px;padding:10px 18px;flex:1;text-align:center;">
        <div style="font-size:.62rem;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">Value</div>
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--green);font-size:.85rem;">20</div>
      </div>
    </div>
    <div style="display:flex;align-items:center;gap:10px;">
      <div style="background:var(--red-soft);border:2px dashed var(--red);border-radius:10px;padding:10px 18px;min-width:80px;text-align:center;">
        <div style="font-size:.62rem;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">Label</div>
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--red-dark);font-size:.85rem;">marks</div>
      </div>
      <div style="color:var(--muted);font-size:1.2rem;font-weight:900;">→</div>
      <div style="background:#f0fff4;border:2px solid var(--green);border-radius:10px;padding:10px 18px;flex:1;text-align:center;">
        <div style="font-size:.62rem;color:var(--muted);font-weight:700;text-transform:uppercase;letter-spacing:1px;margin-bottom:4px;">Value</div>
        <div style="font-family:'Fira Code',monospace;font-variant-ligatures:none;font-weight:800;color:var(--green);font-size:.85rem;">95.5</div>
      </div>
    </div>
  </div>
